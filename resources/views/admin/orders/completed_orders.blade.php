...
<div class="row">
  <div class="col-md-12"> 
    ...
    <ul class="page-breadcrumb breadcrumb">
      <li class="btn-group"> <a href="" class="btn green dropdown-toggle"> <span style="color:#FFF"> Completed Orders  </span></a> </li>
      <li> <i class="fa fa-home"></i> <a href="{{route('adminindex')}}"> Home </a> <i class="fa fa-angle-right"></i> </li>
      <li> <a href="javascript:void(0);"> Completed Orders </a> </li>
  ...
  <div class="col-md-12">
    <div class="tabbable tabbable-custom tabbable-full-width">
      <ul class="nav nav-tabs">
        <li class="active"> <a data-toggle="tab" href="#tab_1_5"> Completed Orders </a> </li>
      </ul>
...
<script type="text/javascript">
  $(document).ready(function(){
      ...
      $('#myTable').DataTable({
        processing: true,
         serverSide: true,
         ajax: "{{route('completed_orders_api')}}",
         columns: [
