...
<div class="row">
  <div class="col-md-12"> 
    ...
    <ul class="page-breadcrumb breadcrumb">
      <li class="btn-group"> <a href="" class="btn green dropdown-toggle"> <span style="color:#FFF"> Cancelled Orders  </span></a> </li>
  ...
  <div class="col-md-12">
    <div class="tabbable tabbable-custom tabbable-full-width">
      <ul class="nav nav-tabs">
        <li class="active"> <a data-toggle="tab" href="#tab_1_5"> Cancelled Orders </a> </li>
      </ul>
...
<script type="text/javascript">
  $(document).ready(function(){
      ...
      $('#myTable').DataTable({
        processing: true,
         serverSide: true,
         ajax: "{{route('cancelled_orders_api')}}",
         columns: [
            ...
            { data: 'cancel_reason',orderable:false},
